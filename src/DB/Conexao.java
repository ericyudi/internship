...
public class Conexao {
    ...
    public boolean conectar(String banco, String usuario, String senha) {
        boolean conectado = false;
        System.out.println("prestes a conectar");
        try {
            //Class.forName(driver); "org.postgresql.Driver");
            //String url = local + banco; //"jdbc:postgresql://localhost/"+banco;
            connect = DriverManager.getConnection(banco, usuario, senha);
            conectado = true;
